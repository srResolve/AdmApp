  ...
  return (
    <View className="flex-1 items-center  bg-white">
      ...
      <ButtonWithIconAndDescription
        ...
        titleClassName="text-lg text-white ml-4"
        subtitleClassName="ml-4 text-white"
        className="w-11/12 mt-5 bg-blue-600 py-4"
      ...
      <ButtonWithIconAndDescription
        ...
        className="w-11/12 bg-yellow-400 mt-4 py-4"
        icon={<FontAwesome6 name="toolbox" size={32} color="white" />}
      />
      <View className="w-full ml-10 mt-4">
        <Text className="text-white text-xl font-bold mt-4">Atalhos</Text>
      </View>
      <View className="w-full flex-row justify-around mt-4">
        <ButtonWithIcon
          ...
          className="w-40 mt-5 bg-[#e4e4e5] flex-col items-start"
        ...
        <ButtonWithIcon
          ...
          titleClassName="text-lg mt-2 text-center text-zinc-800 "
          className="w-40 mt-5 bg-[#ececed] flex-col items-start"
